...
class UserProfileSerializer(serializers.ModelSerializer):
    class Meta:
        model = User
        fields = ( "email", 'name', 'is_verified', 'date_of_birth', 'insta_link', 'position', 'robu_department','is_admin', 'student_id', 'secondary_email', 'phone_number', 'avatar', 'rs_status', 'facebook_profile', 'linkedin_link', 'bracu_start' , 'blood_group', 'gender', 'org')
